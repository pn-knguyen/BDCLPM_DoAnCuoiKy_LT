...
namespace DoAnCuoiKy.Pages.Login_Customer
{
    public class LoginPage
    {
        ...
        public string GetErrorMessage()
        {
            try
            {
                var errorElement = wait.Until(d => d.FindElement(By.CssSelector("div[class='bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded relative mb-4 validation-summary-errors'] ul li")));
