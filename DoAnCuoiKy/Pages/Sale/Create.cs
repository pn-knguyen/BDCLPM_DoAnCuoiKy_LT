...
namespace DoAnCuoiKy.Pages.Sale
{
    public class Create
    {
        ...
        private IWebElement AddSaleButton => wait.Until(d => d.FindElement(By.CssSelector("button[class='bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center']")));
        ...
        public string GetSuccessMessage(string data)
        {
            try
            {
                ...
                return "Thêm chương trình thành công" ?? "";
            }
            catch
            {
                return "";
