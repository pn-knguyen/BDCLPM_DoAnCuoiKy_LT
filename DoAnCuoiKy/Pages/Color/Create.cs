...
namespace DoAnCuoiKy.Pages.Color
{
    public class Create
    {
        ...
        // Perform create for a specific color and verify the value appears in the list. Returns
        // true when the created color is found after submit; false otherwise.
        public bool CreateColorAndVerify(string newColorValue)
        {
            if (string.IsNullOrEmpty(newColorValue))
                return false;
